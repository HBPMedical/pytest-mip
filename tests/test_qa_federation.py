...
def test_main(driver):
    ...
    ApplicationURL = "https://qa.hbpmip.link/"
    ...
    dementia = driver.find_element(By.XPATH, "//div[@id='pathology-select']/div/button")
    dementia.click()

    # 10. Click 'Mentalhealth'
    mentalhealth = driver.find_element(By.LINK_TEXT, "mentalhealth v7")
    mentalhealth.click()
